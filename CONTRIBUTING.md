...
1. Create a branch for your new feature from 'prod' HEAD.

1. Run the tests. Only pull requests with passing tests will be merged.
...
1. Push to your branch to origin and submit a pull request.

1. At this point your branch will be merged into 'test' and deployed for UAT.

1. Once UAT passes the 'test' branch will be merged into 'prod'
